...
const SearchRelatedVideos = ({thumbnail,title,channelTitle,description,publishedAt}) => {
    ...
    return (
        ...
        <div className='ml-5 w-[600px]'>
            ...
            <p className='font-normal text-sm text-gray'><TimeAgo date={publishedAt} /></p>

            <div className=' w-[150px] flex mt-2 items-center'>

                <img src={thumbnail} className="rounded-[50%] h-8 w-[35px] bg-cover" alt="video" />

                <p className='ml-2 font-normal text-sm text-gray w-[115px]'> {channelTitle} </p>
